...
/*
This file defines the base class for ALL UGV modules (TMM, Lidar, GNSS, Vehicle Control, Display, Controller).
Basic classes (TMM, Controller) will be derived directly from this class, whereas those that require networking
to external devices (GNSS, Lidar, VC, Display) will derive from the networked module class (which itself inherits from this class).
